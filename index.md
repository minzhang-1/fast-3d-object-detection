...
<font color=blue>**Input:**</font> point cloud of the scene from the LiDAR sensor. The point cloud is a set of points in 3D space which provides a sparse representation of a 3D shape or object. Each point is composed of the 3D coordinates X, Y and Z.
